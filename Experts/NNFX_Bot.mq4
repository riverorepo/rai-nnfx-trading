...
input int                 InpSSL_C1_MA1Len   = 10;            // C1 SSL: MA1 Length
...
input int                 InpSSL_C1_MA2Len   = 10;            // C1 SSL: MA2 Length
...
input int                 InpSSL_Exit_MA1Len   = 10;            // Exit SSL: MA1 Length
...
input int                 InpSSL_Exit_MA2Len   = 10;            // Exit SSL: MA2 Length
...
int EvaluateEntry()
{
   ...
   // We also allow "continuation" if already on the right side but
   // for strict NNFX, require a cross. Enable continuation by commenting this:
   if(!baselineCross)
   {
      // No fresh baseline cross on this bar
      return(0);
   }
